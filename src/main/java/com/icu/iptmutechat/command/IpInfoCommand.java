...
public class IpInfoCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        sender.sendMessage(configManager.getIpInfoAccentMessage("ip-info-player", "player", playerName, "#FACC15"));
        sender.sendMessage(configManager.getIpInfoAccentMessage("ip-info-address", "ip", latestIp, "#EF4444"));
        sender.sendMessage(configManager.getIpInfoMessage("ip-info-same-title", "count", String.valueOf(sameIpPlayers.size())));
